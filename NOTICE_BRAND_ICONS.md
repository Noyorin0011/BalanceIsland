...
The provider identification icons embedded in this project use brand marks only
to identify the API selected by the user.

- DeepSeek icon: Simple Icons v16, brand color `#4D6BFE`.
- OpenAI icon: Simple Icons v13.14.0, rendered as the unmodified monochrome mark.
...
imply endorsement, sponsorship, or partnership.
